  ...
  Future<void> Authen() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('auth_patient_invalid'.tr()),
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'auth_patient_fullname'.tr(),
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'auth_patient_fullname_required'
                                          .tr();
                                    }
                                    return null;
                                  },
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'auth_patient_phone'.tr(),
                                    labelStyle: const TextStyle(
                                      color: Color(0xFF757575),
                                    ),
                                    prefixIcon: const Icon(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'auth_patient_phone_required'.tr();
                                    }
                                    return null;
                                  },
                                ),
                                ...
                                SizedBox(
                                  width: double
                                      .infinity, // Force le bouton à prendre toute la largeur du formulaire
