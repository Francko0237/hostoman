...
const Color npAccentColor = Color(0xFF4285F4); // Une nuance plus claire pour l'accentuation
const Color npSuccessColor = Color(0xFF34A853); // Vert Google pour le succès
const Color npErrorColor = Color(0xFFEA4335); // Rouge Google pour les erreurs/absence de données
        ...
        child: Container(
          ...
          child: loading
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints(maxWidth: isDesktop ? 900 : (isTablet ? 700 : double.infinity)),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(28), // Rayon plus grand
                        boxShadow: [
                          BoxShadow(
                            color: npPrimaryColor.withOpacity(0.4), // Ombre plus prononcée
                            blurRadius: 25,
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: npCardColor,
                              shape: BoxShape.circle,
                              border: Border.all(color: npCardColor.withOpacity(0.5), width: 3), // Bordure légère
                              boxShadow: [
                                BoxShadow(
                            ...
                            child: Center(
                              ...
                              (medecin!.nom.isNotEmpty ? medecin!.nom[0] : '').toUpperCase(),
                                style: TextStyle(
                                  color: npPrimaryColor,
                                  fontSize: 56, // Taille de texte plus grande
                          ...
                          Text(
                            'Mr. ${medecin!.prenom} ${medecin!.nom}', // Affichage "Dr."
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                          ...
                          if (medecin!.specialite != null && medecin!.specialite!.isNotEmpty)
                            Chip( // Utilisation d'un Chip pour la spécialité
                              label: Text(medecin!.specialite!,
                                  style: TextStyle(
                                    fontSize: 16,
                                    color: npPrimaryColor,
                                    fontWeight: FontWeight.w600,
                              ...
                              materialTapTargetSize: MaterialTapTargetSize.shrinkWrap, // Réduire la zone de touche
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                            ),
                        ],
                      ),
                    ),
                    const SizedBox(height: 32), // Espacement augmenté entre les sections

                    // Section Informations Personnelles
                    Container(
                      padding: const EdgeInsets.all(24), // Espacement intérieur ajusté
                      decoration: BoxDecoration(
                        color: npCardColor,
                        borderRadius: BorderRadius.circular(20),
                        boxShadow: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(Icons.person_outline, color: npPrimaryColor, size: 28), // Icône plus grande
                              const SizedBox(width: 12),
                              const Text(
                          ...
                          const Divider(height: 30, thickness: 1, color: npBackgroundColor), // Séparateur
                          _buildInfoCardRow(Icons.phone, 'Téléphone', medecin!.telephone.toString()),
                          _buildInfoCardRow(Icons.email, 'Email', medecin!.email ?? 'Non renseigné'),
                          _buildInfoCardRow(Icons.location_on, 'Adresse', medecin!.adresse ?? 'Non renseigné'),
                    ...
                    Container(
                      padding: const EdgeInsets.all(20), // Espacement augmenté
                      decoration: BoxDecoration(
                        color: npCardColor,
                        borderRadius: BorderRadius.circular(20),
                        boxShadow: [
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: npSuccessColor.withOpacity(0.15), // Opacité augmentée
                              shape: BoxShape.circle,
                            ),
                            child: Icon(
                          ...
                          Text(
                            '$totalPatients',
                            style: TextStyle(
                              fontSize: 64, // Taille de texte beaucoup plus grande
                    ...
                    const SizedBox(height: 50), // Espacement final augmenté
                    Center(
                      child: Text(
