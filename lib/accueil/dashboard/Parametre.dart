...
const Color npBackground = Color(0xFFF4F7FB);
const Color npTextDark = Color(0xFF1A1A2E);
const Color npTextMuted = Color(0xFF64748B);
const Color npDanger = Color(0xFFDC2626);
const Color npSuccess = Color(0xFF16A34A);
            ...
            children: [
              ...
              ..._kLocales.map((l) {
                ...
                return Padding(
                  ...
                  child: Material(
                    color: isCurrent
                        ? npPrimaryColor.withValues(alpha: 0.08)
                        : Colors.grey.shade50,
  ...
  void _showAboutSheet(BuildContext context) {
    showAboutDialog(
      ...
      applicationIcon: Container(
        ...
        height: 48,
        decoration: BoxDecoration(
          color: npPrimaryColor.withValues(alpha: 0.1),
          borderRadius: BorderRadius.circular(12),
        ),
        child: const Icon(Icons.local_hospital, color: npPrimaryColor),
      ),
