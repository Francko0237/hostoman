            ...
            children: [
              ...
              ..._kLocales.map((l) {
                ...
                return Padding(
                  ...
                  child: Material(
                    color: isCurrent
                        ? mmPrimaryColor.withValues(alpha: 0.08)
                        : Colors.grey.shade50,
  ...
  void _showAboutSheet(BuildContext context) {
    showAboutDialog(
      ...
      applicationIcon: Container(
        ...
        height: 48,
        decoration: BoxDecoration(
          color: mmPrimaryColor.withValues(alpha: 0.1),
          borderRadius: BorderRadius.circular(12),
        ),
        child: const Icon(Icons.local_hospital, color: mmPrimaryColor),
      ),
              ...
              background: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [mmPrimaryColor, mmAccentColor],
                  ),
                ),
                child: Stack(
                  children: [
